...
CREATE PROC pa_precios_bajos
as 
select cod_articulo as codigo, descripcion, pre_unitario as precio
from articulos
where pre_unitario < 100;

exec pa_precios_bajos

-- Modigica un procedimiento de almacenado
alter proc pa_precios_bajos
as 
select cod_articulo as codigo, descripcion, pre_unitario as precio
from articulos
where pre_unitario < 200;

-- Procedimiento de almacenamiento con paramtros
create proc pa_precios_bajos2
@precio money 
as 
select  cod_articulo as codigo, descripcion, pre_unitario as precio
from articulos
...
exec pa_precios_bajos2 100

--Listar articulos con precios entre dos valores
create proc pa_precios_masomenos_bajos
@precio1 money, 
@precio2 money
as 
select  cod_articulo as codigo, descripcion, pre_unitario as precio
...
exec pa_precios_masomenos_bajos 100, 200
